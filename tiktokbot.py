...
if selection == "1":
    ...
    sounds = input().split("&&") # "6927378115278736133&&7030409649409182466&&7026760491657612037&&6976292766745758470&&6938019865257085698"
...
while (n_ciclo<3):
	...
	if videoType == 1:
	    ...
	    if videoType == 2:
	        ...
	        for x in sounds:
	            x = x.split("ps://www.tiktok.com/music/")[0].split("?")[0]
	...
	command_to_pass = "ffmpeg -f concat -i downloaded/concat.txt -safe 1 -r 30 -fflags +genpts -c:a copy output/"+ date_time+".mp4"

	print(command_to_pass)

	os.system(command_to_pass)
